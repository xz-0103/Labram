...
def get_dataset(args):
    if args.dataset == 'TUAB':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUAB_dataset("dataset_pkl")
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_TUEV_dataset("dataset_pkl")
        ...
        args.nb_classes = 3  # Assuming SEED dataset has 3 classes (adjust if necessary)
